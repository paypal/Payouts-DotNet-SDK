...
namespace PayoutsSdk.Payouts
{
    ...
    /// </summary>
    public class PayoutsPostRequest : HttpRequest
    {
        public PayoutsPostRequest() : base("/v1/payments/payouts?", HttpMethod.Post, typeof(CreatePayoutResponse))
        {
