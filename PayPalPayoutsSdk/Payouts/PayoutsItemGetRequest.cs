...
namespace PayoutsSdk.Payouts
{
    ...
    /// </summary>
    public class PayoutsItemGetRequest : HttpRequest
    {
        public PayoutsItemGetRequest(string PayoutItemId) : base("/v1/payments/payouts-item/{payout_item_id}?", HttpMethod.Get, typeof(PayoutItemResponse))
        {
            try {
